describe('middleware', () => {
  ...
  test('require', () => {
    ...
    expect(mockAsyncContext.createNamespace).toHaveBeenCalledWith(expectedNamespaceName);
  });
